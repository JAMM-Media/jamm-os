...
import app.services.tax_organizer_service as tax_organizer_service
...
async def send_organizer(
    ...
    return await tax_organizer_service.send_organizer(
        db=db, payload=payload, client=client, engagement=engagement,
        firm=current_firm, current_user_id=current_user.id,
...
def send_organizer_magic_link(
    ...
    return tax_organizer_service.send_organizer_magic_link(
        db=db, organizer=organizer, organizer_id=organizer_id, client=client,
        firm=current_firm, current_user_id=current_user.id,
    )
