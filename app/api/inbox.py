...
def reply_thread(
    ...
    if data.provider == "outlook":
        return send_outlook_reply(integration, data.thread_id, data.to, data.subject, data.body)
    return send_gmail_reply(integration, data.thread_id, data.to, data.subject, data.body)
...
def compose_email(
    ...
    if data.provider == "outlook":
        return send_outlook_compose(integration, data.to, data.subject, data.body)
    return send_gmail_compose(integration, data.to, data.subject, data.body)
